...
<body class="bg-light">
    {{-- Header --}}
    <div class="header bg-orange-50 text-white py-2">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-3">
                    <a href="" target="_blank" class="text-white">Seller</a>
                </div>
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            @else
                                ...
                                <a class="dropdown-item" href="#"
                                    onclick="document.querySelector('#form-logout').submit()">Keluar</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 text-white-80">
                    ...
                    <p class="mb-lg-3 mb-1">
                        <a href="{{ url('/campaign') }}" class="text-white-80 text-decoration-none">Galang Dana</a>
                        <br>
                ...
                <div class="col-lg-3 text-white-80">
                    ...
                    <p class="mb-lg-3 mb-1"><a href="{{ url('/about') }}"
                            class="text-white-80 text-decoration-none">Tentang Kami</a></p>
                    <p class="mb-lg-3 mb-1"><a href="#" class="text-white-80 text-decoration-none">Syarat dan
                            Ketentuan</a></p>
                    <p class="mb-lg-3 mb-1"><a href="#" class="text-white-80 text-decoration-none">Kebijakan
                            dan Privasi</a></p>
                </div>
                <div class="col-lg-3 text-white-80">
                    <h5 class="mb-lg-4 mb-2">Mari Berbagi</h5>
